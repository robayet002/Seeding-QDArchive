...
A research tool that discovers, downloads, and catalogues **Qualitative Data Analysis (QDA) project files** from traget repositories. It scrapes metadata and files from SADA (DataFirst UCT) and Dataverse Norway storing everything in a structured SQLite database across five normalised tables.
