...
def process_record(record: dict, source_name: str):
    ...
    project_data = {
        ...
        "type":                         "NOT_A_PROJECT",  # derived later by run_classification
...
def main():
    ...
    # ------------------------------------------------------------------
    # Classification stage (Classification_instruction)
    # ------------------------------------------------------------------
    print("\nRunning classification...")
    from run_classification import classify_all
    from export_xlsx import export_classification_table
